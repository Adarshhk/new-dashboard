...
const baseUrl = ref("http://localhost:8081");
...
export { makeRequest,canMakeRequest,  state, setToken, getToken,isAuthenticated, getisAuthenticated, setisAuthenticated, logout,  token };
