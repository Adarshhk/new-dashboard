...
import { state } from "../../request/request"
...
export const useStrategiesStore = defineStore("strategies", () => {
  ...
  const getStrategies = async () => {
        ...
        strategies: [
          {
            ...
            risk: "HIGH",
            message:
              "The Domain Price Action strategy is a dynamic approach centred around time and price crossovers, leveraging price patterns within specific time periods.",
          ...
          },
          {
            ...
            risk: "HIGH",
            message:
              "The Domain Trend strategy is a specialised approach designed to capitalise on trending market conditions.",
          ...
          },
          {
            ...
            risk: "HIGH",
            message:
              "The Domain Range Breakout strategy is a dynamic trading approach that combines trend identification with strategic entry points based on significant market levels.",
    ...
    try {
      if (response.data) {
        strategies.value =
          response.data.strategies.sort((a, b) => b.id - a.id) || []
